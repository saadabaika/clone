...
# URL dyal website li 7biti ach ntesti
url = "https://endurisgroup.com/"
...
# workspace dyalna
workspace = os.path.dirname(os.path.realpath(_file_))
...
class Extractor:
    ...
    #  php (new test) et links dyal les page
    ...
    def download_file(self, url, output_path):
        ...
        # mssa7 query string and http mn URL
        url = url.split('?')[0]
